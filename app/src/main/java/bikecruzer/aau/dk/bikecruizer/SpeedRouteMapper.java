 ...
 */
public class SpeedRouteMapper extends AsyncTask<String,Void,SpeedRoute> {
    private Activity mainActivity;
    private GoogleMap gmap;
    private SpeedRoute speedRoute;
    private Integer counter;
    private Main_Speedfragment context;

    public SpeedRouteMapper(SpeedRoute route, Activity a, GoogleMap map, Integer count, Main_Speedfragment context){
        this.speedRoute = route;
        this.mainActivity = a;
        this.gmap = map;
        this.counter = count;
    ...
    @Override
    protected SpeedRoute doInBackground(String... index){
